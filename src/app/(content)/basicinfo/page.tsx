...
export default function BasicInfo() {
    ...
    return (
        <main className={`flex flex-col w-[100vw] h-[100vh] ${dm_sans.className} pt-[2vh] overflow-hidden`}>
            <AppBar/>
            <Modal
                    ...
                    <div className = "flex flex-col w-full h-full">
                        ...
                        >
                            <div className="flex flex-row divide-black divide-x-[1px]">
                                <label htmlFor='name' className="text-xl font-bold w-[20vw] text-center">
                                    Name
                                </label>
                                <input
                                    id='name'
                            ...
                            <div className={`"flex flex-row w-fill justify-evenly" + ${modified? "" : "invisible"}`}>
                                <button>
                                    Save
                                </button>
                                <button formAction={() => {
